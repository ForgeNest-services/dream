...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Sign in — Dream PMS" },
      { name: "twitter:description", content: "Secure staff sign-in for Dream PMS, the property management system for hotels: bookings, folios, invoices and reporting." },
    ],
    links: [
      {
        rel: "stylesheet",
